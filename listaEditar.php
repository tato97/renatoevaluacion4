...
<main class="container">
  <div class="shadow p-3 mb-5 bg-body rounded">
    ...
    <form method="POST" action="usuarioEditar.php" class="form-horizontal">
      ...
      <button type="submit" name="editar" value="Submit" class="btn btn-primary btn-lg"><span class="fas fa-user-edit"></span> Editar</button>
