...
<html lang="es">
  <head>
    ...
    <title>Crear Credencial - Evaluación 4 Tipo 3</title>
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
      <ul class="navbar-nav me-auto mb-2 mb-md-0">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" id="dropdown01" data-bs-toggle="dropdown" aria-expanded="false"><span class="fas fa-users"></span> Usuarios</a>
        ...
        <li class="nav-item">
          <a class="nav-link  active" href="listaCredencial.php"><span class="fas fa-id-card"></span> Crear Credencial</a>
        </li>
      </ul>
...
<main class="container">
  <div class="shadow p-3 mb-5 bg-body rounded">
    <h1><span class="fas fa-id-card"></span> Crear Credencial</h1>
    <form method="POST" target="_blank" action="credencial.php" class="form-horizontal">
      ...
      <button type="submit" name="credencial" value="Submit" class="btn btn-primary btn-lg"><span class="fas fa-id-card"></span> Crear Credencial</button>
