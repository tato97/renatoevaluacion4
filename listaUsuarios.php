...
<main class="container">
  <div class="shadow p-3 mb-5 bg-body rounded">
    <h1><span class="fas fa-list-ul"></span> Lista de usuarios</h1>
    <form method="POST" action="usuarioDatos.php" class="form-horizontal">
    ...
    <button type="submit" name="consultar" value="Submit" class="btn btn-primary btn-lg"><span class="fas fa-user-tag"></span> Consultar</button>
